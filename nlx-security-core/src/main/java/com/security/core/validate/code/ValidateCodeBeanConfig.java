...
import com.security.core.validate.code.img.ImageValidateCodeGenerator;
...
public class ValidateCodeBeanConfig {
    ...
    public ValidateCodeGenerator imageValidateCodeGenerator() {
        ImageValidateCodeGenerator imageCodeGenerator = new ImageValidateCodeGenerator(securityProperties);
